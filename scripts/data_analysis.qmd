---
title: Data analysis
subtitle: Vocal interactions in Thyroptera tricolor
...
sketchy::load_packages(packages = c("igraph", "bipartite", "asnipe", "assortnet", "ggplot2", "ggmap", "ecodist", "igraphdata", "statnet", "RColorBrewer", "tidyverse", "geosphere", "mapproj", "sna", "stringr", "lme4", "glmmTMB", "broom.mixed", "boot", "patchwork", "performance", "MASS"))
...
## Plot networks
```{r plot networks 2021, message=FALSE}
