...
points(x = seq(-1.12, 0.4, length.out = 3), y = rep(-1.2, 3), pch = 21, cex = 4, bg = color_mapping, col = "black")

text(x = seq(-1.12, 0.4, length.out = 3) + 0.06, y = rep(-1.2, 3), labels = names(color_mapping), pos = 4, cex = 2)
...
# save model results
write.csv(coefs2, file="inquiry_model_results_excluding_zero_responses.csv")
